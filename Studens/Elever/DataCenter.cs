...
namespace Elever
{
    ...
    enum DataType { SetNewOrd, GetDataFromOrder, SetDataToOrder, GetStudents, GetPlaces, GetAllOrder, GetStudentOrder, GetPlaceOrder, AddStudent, AddPlace, GetOrderCount, DeletePlace, DeleteOrder, DeleteStudent, OrderExist, GetStudent, GetPlace, SetBeskrivning, GetBeskrivning, GetImage, SetImage, Check };
